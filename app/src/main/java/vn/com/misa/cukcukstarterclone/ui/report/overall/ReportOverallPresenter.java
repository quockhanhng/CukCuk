 ...
 */
public class ReportOverallPresenter implements ReportOverallContract.Presenter {

    private ReportOverallContract.View view;

    private final ReportRepository reportRepository;

    public ReportOverallPresenter(ReportRepository reportRepository) {
        this.reportRepository = reportRepository;
    }

    @Override
    public void attach(ReportOverallContract.View view) {
        this.view = view;
    }
